...
Shader"UnityChanWARPSTARCustomToonShader/Out/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilOut_LEqual" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut_LEqual/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut_LEqual/FORWARD_DELTA"
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut_LEqual/SHADOWCASTER"
    }
