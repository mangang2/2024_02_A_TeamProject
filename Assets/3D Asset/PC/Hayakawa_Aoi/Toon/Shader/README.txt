...
● **[日本語マニュアル（v.2.0.9版）](https://github.com/unity3d-jp/UnityChanWARPSTARCustomToonShaderVer2_Project/blob/blob/release/legacy/2.0/Manual/UTS2_Manual_ja.md)が提供されています。合わせてご利用ください。**  
...
● **[English manual for v.2.0.9](https://github.com/unity3d-jp/UnityChanWARPSTARCustomToonShaderVer2_Project/blob/blob/release/legacy/2.0/Manual/UTS2_Manual_en.md) is available now.**  
