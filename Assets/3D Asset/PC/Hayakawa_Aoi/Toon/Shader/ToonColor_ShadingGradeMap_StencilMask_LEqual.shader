...
Shader"UnityChanWARPSTARCustomToonShader/Mask/NoOutline/ToonColor_ShadingGradeMap_StencilMask_LEqual" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_StencilMask_LEqual/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_StencilMask_LEqual/FORWARD_DELTA"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_StencilMask_LEqual/SHADOWCASTER"
