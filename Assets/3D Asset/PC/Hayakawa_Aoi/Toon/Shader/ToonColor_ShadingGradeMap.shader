...
Shader "UnityChanWARPSTARCustomToonShader/NoOutline/ToonColor_ShadingGradeMap" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Toon_ShadingGradeMap/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Toon_ShadingGradeMap/FORWARD_DELTA"
        UsePass "UnityChanWARPSTARCustomToonShader/Toon_ShadingGradeMap/SHADOWCASTER"
