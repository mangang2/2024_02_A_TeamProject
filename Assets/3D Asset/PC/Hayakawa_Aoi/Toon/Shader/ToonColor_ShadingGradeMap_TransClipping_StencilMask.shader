...
Shader"UnityChanWARPSTARCustomToonShader/Mask/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilMask" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_TransClipping_StencilMask/SHADOWCASTER"
    }
