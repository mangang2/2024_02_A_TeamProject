#define ADD_CODE_SADAFUMI
//Unitychan Toon Shader ver.2.0
//UTS2CAOIGUI.cs for UTS2 v.2.0.9
...
namespace UnityChanWARPSTARCustom
{
    public class UTS2CAOIGUI : ShaderGUI {
        ...
        int _renderQueue = (int)UnityEngine.Rendering.RenderQueue.Geometry;
        int _autoRenderQueue = 1;
...
#if ADD_CODE_SADAFUMI
        static bool _Custom_Menu_Foldout = false;

        //static bool _Debug_SHR_Show_Foldout = false;
        //static bool _Debug_MEO_Show_Foldout = false;
        //static bool _Debug_Show_Vertex_Color_Foldout = false;
#endif

#if ADD_CODE_SADAFUMI
        //ADD CODE SADAFUMI
        //bool _Color_Mesh_Off = false;
        //bool _Use_SHRMap = false;
        //bool _Use_MEOMap = false;
//ADD CODE SADAFUMI
#endif
        // -----------------------------------------------------
        ...
        MaterialProperty onlyOutline = null;
        MaterialProperty useSHR_Map = null;
        MaterialProperty useMEO_Map = null;

        MaterialProperty SHR_Map = null;
        MaterialProperty MEO_Map = null;

        //MaterialProperty S_Color = null;
        //MaterialProperty H_Color = null;
        //MaterialProperty C_Color = null;


        //MaterialProperty R_Color = null;
        //MaterialProperty M_Color = null;
        //MaterialProperty O_Color = null;

        //MaterialProperty Vertex_R_Color = null;
        //MaterialProperty Vertex_G_Color = null;
        //MaterialProperty Vertex_B_Color = null;
        //MaterialProperty Vertex_A_Color = null;

        //MaterialProperty Normals_Color = null;
        //MaterialProperty Check_Outline_Normal = null;
        //MaterialProperty Check_Vertex_Color = null;
        //MaterialProperty MatCap_Color = null;

        MaterialProperty useNormalsBakedToUV = null;
        MaterialProperty useClip = null;
        MaterialProperty offset_Z_Bias = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            offset_Z_Bias = FindProperty("_Offset_Z_Bias", props, false);
...
#if ADD_CODE_SADAFUMI
            //ADD CODE SADAFUMI
            onlyOutline = FindProperty("_Color_Mesh_Off", props);
            useSHR_Map = FindProperty("_Use_SHRMap", props);
            useMEO_Map = FindProperty("_Use_MEOMap", props);
            SHR_Map = FindProperty("_SHRTex", props);
            MEO_Map = FindProperty("_MEOTex", props);

            //S_Color = FindProperty("_S_Color", props);
            //H_Color = FindProperty("_H_Color", props);
            //C_Color = FindProperty("_C_Color", props);

            //R_Color = FindProperty("_R_Color", props);
            //M_Color = FindProperty("_M_Color", props);            
            //O_Color = FindProperty("_O_Color", props);


            //Vertex_R_Color = FindProperty("_Vertex_R_Color", props);
            //Vertex_G_Color = FindProperty("_Vertex_G_Color", props);
            //Vertex_B_Color = FindProperty("_Vertex_B_Color", props);
            //Vertex_A_Color = FindProperty("_Vertex_A_Color", props);

            //Normals_Color = FindProperty("_Normals_Color", props);
            //Check_Outline_Normal = FindProperty("_Check_Outline_Normal", props);
            //Check_Vertex_Color = FindProperty("_Check_Vertex_Color", props); 
            //MatCap_Color = FindProperty("_MatCap_Color", props);

            useNormalsBakedToUV = FindProperty("_Use_Normals_BakedToUV", props);
            useClip = FindProperty("_Use_Clip", props);
            //ADD CODE SADAFUMI
#endif
        }
        // --------------------------------
    ...
    // --------------------------------
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            _Custom_Menu_Foldout = Foldout(_Custom_Menu_Foldout, "【カスタムメニュー】");
            if (_Custom_Menu_Foldout)
            {
                EditorGUI.indentLevel++;
                //EditorGUILayout.Space(); 
                GUI_CustomMenu(material);
        ...
        void OpenManualLink(){
            ...
            //{
            //        Application.OpenURL("https://github.com/unity3d-jp/UnityChanWARPSTARCustomToonShaderVer2_Project/blob/release/legacy/2.0/Manual/UTS2_Manual_ja.md");
            //}
            //if (GUILayout.Button("English manual",middleButtonStyle))
            //{
            //        Application.OpenURL("https://github.com/unity3d-jp/UnityChanWARPSTARCustomToonShaderVer2_Project/blob/release/legacy/2.0/Manual/UTS2_Manual_en.md");
            //}
        }
        ...
        void GUI_OptionMenu(Material material){
            ...
            //ShaderCustom.OptionMenuCustom(material);
#if ADD_CODE_SADAFUMI
            //ADD CODE SADAFUMI
            //color_Mesh_Off
            //EditorGUILayout.BeginHorizontal();
            //_Color_Mesh_Off = EditorGUILayout.Toggle("Color Mesh Off", _Color_Mesh_Off);
            //material.SetInt("_Color_Mesh_Off", _Color_Mesh_Off ? 1 : 0);

            //if (_Color_Mesh_Off != material.GetInt("_Color_Mesh_Off")) 
            //{
                
            //}
            //if (material.HasProperty("_Color_Mesh_Off"))
            //{
            //    if (material.GetInt("_Color_Mesh_Off") == 1)
            //    {
            //        _Color_Mesh_Off = true; //UTS2 Custom GUI Biginner
            //    }
            //    else
            //    {
            //        _Color_Mesh_Off = false; //UTS2 Custom GUI Pro
            //    }
            //}
            //EditorGUILayout.BeginHorizontal();
            //EditorGUILayout.PrefixLabel("Outline Only");
            //if (_Color_Mesh_Off == false)
            //{
            //    if (GUILayout.Button("Off", middleButtonStyle))
            //    {
            //        material.SetInt("_Color_Mesh_Off", 1); //UTS2 Custom GUI Biginner
            //    }
            //}
            //else
            //{
            //    if (GUILayout.Button("On", middleButtonStyle))
            //    {
            //        material.SetInt("_Color_Mesh_Off", 0); //UTS2 Custom GUI Pro
            //    }
            //}
            //EditorGUILayout.EndHorizontal();
            m_MaterialEditor.ShaderProperty(onlyOutline, "Outline Only");
//ADD CODE SADAFUMI
#endif
        ...
        void GUI_CustomMenu(Material material)
        {
            m_MaterialEditor.ShaderProperty(useNormalsBakedToUV, "UVにベイクした法線を使う");
            m_MaterialEditor.ShaderProperty(useClip, "クリッピングを使用する");
            
            GUILayout.Box("", GUILayout.ExpandWidth(true), GUILayout.Height(1));

            m_MaterialEditor.ShaderProperty(useSHR_Map, "統合マップ(SHC)を使う");
            m_MaterialEditor.TextureProperty(SHR_Map, "統合マップ(R:ShadingGradeMap G:Highcolor B:Cutoff)");

            if (material.GetInt("_Use_SHRMap") == 1)
            {
                //m_MaterialEditor.ShaderProperty(S_Color, "Debug Show SHC S Color");
                //m_MaterialEditor.ShaderProperty(H_Color, "Debug Show SHC H Color");
                //m_MaterialEditor.ShaderProperty(C_Color, "Debug Show SHC C Color");

                GUILayout.Box("", GUILayout.ExpandWidth(true), GUILayout.Height(1));
            }
            m_MaterialEditor.ShaderProperty(useMEO_Map, "統合マップ(RMO)を使う");
            m_MaterialEditor.TextureProperty(MEO_Map, "統合マップ(R:Rim G:MatCap B:Outline)");

            if (material.GetInt("_Use_MEOMap") == 1)
            {
                //m_MaterialEditor.ShaderProperty(R_Color, "Debug Show RMO R Color");
                //m_MaterialEditor.ShaderProperty(M_Color, "Debug Show RMO M Color");
                //m_MaterialEditor.ShaderProperty(O_Color, "Debug Show RMO O Color");

                GUILayout.Box("", GUILayout.ExpandWidth(true), GUILayout.Height(1));
            }

            //m_MaterialEditor.ShaderProperty(Vertex_R_Color, "Debug Show Vertex R Color");
            //m_MaterialEditor.ShaderProperty(Vertex_G_Color, "Debug Show Vertex G Color");
            //m_MaterialEditor.ShaderProperty(Vertex_B_Color, "Debug Show Vertex B Color");
            //m_MaterialEditor.ShaderProperty(Vertex_A_Color, "Debug Show Vertex A Color");

            //m_MaterialEditor.ShaderProperty(Normals_Color, "Debug Show Normals");
            //m_MaterialEditor.ShaderProperty(Check_Outline_Normal, "Debug Show Outline Normals");
            //m_MaterialEditor.ShaderProperty(Check_Vertex_Color, "Debug Show Vertex Color");
            

            //m_MaterialEditor.ShaderProperty(MatCap_Color, "Debug Show MatCap");
            GUILayout.Box("", GUILayout.ExpandWidth(true), GUILayout.Height(1));
        }
        ...
        void GUI_Outline(Material material)
        {
            ...
            m_MaterialEditor.RangeProperty(offset_Z_Bias, "Offset Z Bias");
...
}// End of namespace UnityChanWARPSTARCustom