...
Shader"UnityChanWARPSTARCustomToonShader/Out/NoOutline/ToonColor_ShadingGradeMap_Transparent_StencilOut_GEqual" {
    Properties {
...
//ADD CODE SADAFUMI
        [Toggle(_COLOR_MESH_OFF)] _Color_Mesh_Off("Color Mesh Off", Int) = 0
        [Toggle(_USE_SHRMAP)] _Use_SHRMap("SHR Map", Int) = 0
        [Toggle(_USE_MEOMAP)] _Use_MEOMap("MEO Map", Int) = 0
        _SHRTex("SHR", 2D) = "white" {}
        _MEOTex("MEO", 2D) = "white" {}

        [Toggle(_USE_NORMALS_BAKEDTOUV)] _Use_Normals_BakedToUV("Normals baked to UV", Int) = 0

        //[Toggle(_S_COLOR)] _S_Color("Debug SHC S Color", Int) = 0
        //[Toggle(_H_COLOR)] _H_Color("Debug SHC H Color", Int) = 0
        //[Toggle(_C_COLOR)] _C_Color("Debug SHC C Color", Int) = 0

        //[Toggle(_R_COLOR)] _R_Color("Debug RMO R Color", Int) = 0
        //[Toggle(_M_COLOR)] _M_Color("Debug RMO M Color", Int) = 0
        //[Toggle(_O_COLOR)] _O_Color("Debug RMO O Color", Int) = 0

        //[Toggle(_VERTEX_R_COLOR)] _Vertex_R_Color("Debug Vertex R Color", Int) = 0
        //[Toggle(_VERTEX_G_COLOR)] _Vertex_G_Color("Debug Vertex G Color", Int) = 0
        //[Toggle(_VERTEX_B_COLOR)] _Vertex_B_Color("Debug Vertex B Color", Int) = 0
        //[Toggle(_VERTEX_A_COLOR)] _Vertex_A_Color("Debug Vertex A Color", Int) = 0

        //[Toggle(_NORMALS_COLOR)] _Normals_Color("Debug Normals Color", Int) = 0
        //[Toggle(_CHECK_OUTLINE_NORMAL)] _Check_Outline_Normal("Debug Normals Color", Int) = 0
        //[Toggle(_MATCAP_COLOR)] _MatCap_Color("Debug MatCap Color", Int) = 0

        _Check_Vertex_Color("Check_Vertex_Color", Range(0, 4)) = 0
        _Offset_Z_Bias("_Offset_Z_Bias", Range(0, 20)) = 0
        [Toggle(_USE_CLIP)] _Use_Clip("Use Clip", Int) = 1
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        //"UnityChanWARPSTARCustomToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD"
        Pass {
            Name "FORWARD"
            Tags {
...
//ADD CODE SADAFUMI
            #pragma multi_compile _ _COLOR_MESH_OFF
            #pragma multi_compile _ _USE_SHRMAP
            #pragma multi_compile _ _USE_MEOMAP
            #pragma multi_compile _ _USE_CLIP
#ifdef EDITOR_VISUALIZATION        
            //#pragma multi_compile _ _S_COLOR
            //#pragma multi_compile _ _H_COLOR
            //#pragma multi_compile _ _C_COLOR
            //#pragma multi_compile _ _M_COLOR
            //#pragma multi_compile _ _R_COLOR
            //#pragma multi_compile _ _O_COLOR

            //#pragma multi_compile _ _VERTEX_R_COLOR
            //#pragma multi_compile _ _VERTEX_R_COLOR
            //#pragma multi_compile _ _VERTEX_B_COLOR
            //#pragma multi_compile _ _VERTEX_B_COLOR

            //#pragma multi_compile _ _NORMALS_COLOR
            //#pragma multi_compile _ _CHECK_OUTLINE_NORMAL
            //#pragma multi_compile _ _MATCAP_COLOR
#endif
//ADD CODE SADAFUMI
            //
        ...
        //UsePass "UnityChanWARPSTARCustomToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD"
        //UsePass "UnityChanWARPSTARCustomToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD_DELTA"
        //UsePass "UnityChanWARPSTARCustomToonShader/Toon_ShadingGradeMap_TransClipping/SHADOWCASTER"
    }
    FallBack "Legacy Shaders/VertexLit"
    CustomEditor "UnityChanWARPSTARCustom.UTS2CAOIGUI"
}
