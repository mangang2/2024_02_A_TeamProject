...
Shader"UnityChanWARPSTARCustomToonShader/Out/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilOut_GEqual" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut_GEqual/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut_GEqual/FORWARD_DELTA"
        UsePass"UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut_GEqual/SHADOWCASTER"
    }
