...
Shader"UnityChanWARPSTARCustomToonShader/Mask/NoOutline/ToonColor_ShadingGradeMap_StencilMask" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_StencilMask/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_StencilMask/FORWARD_DELTA"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_StencilMask/SHADOWCASTER"
