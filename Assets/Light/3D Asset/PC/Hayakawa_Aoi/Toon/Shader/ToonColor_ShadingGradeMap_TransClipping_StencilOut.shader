...
Shader"UnityChanWARPSTARCustomToonShader/Out/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilOut" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanWARPSTARCustomToonShader/Out/Toon_ShadingGradeMap_TransClipping_StencilOut/SHADOWCASTER"
    }
