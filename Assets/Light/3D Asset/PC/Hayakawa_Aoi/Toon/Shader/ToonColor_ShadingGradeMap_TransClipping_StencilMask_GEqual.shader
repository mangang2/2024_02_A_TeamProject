...
Shader"UnityChanWARPSTARCustomToonShader/Mask/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilMask_GEqual" {
    Properties {
...
//ADD CODE SADAFUMI
    ...
    SubShader {
        ...
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_TransClipping_StencilMask_GEqual/FORWARD"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_TransClipping_StencilMask_GEqual/FORWARD_DELTA"
        UsePass "UnityChanWARPSTARCustomToonShader/Mask/Toon_ShadingGradeMap_TransClipping_StencilMask_GEqual/SHADOWCASTER"
    }
